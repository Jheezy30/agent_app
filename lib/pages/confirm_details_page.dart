...
class _ConfirmDetailsPageState extends State<ConfirmDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<FormController, MyController>(builder: (__, form,myController, _) =>  Scaffold(
        body: Padding(
          padding:
                          ...
                          showDialog(
                            context: context,
                             builder: (context) => CustomAlertDialog(
                               title: 'Success',
                               message: 'Vendor details is updated successfully',
                             )
                             ).then((_) {
                              myController.clearWalletController();
